    ...
    <form id="reportForm">
      ...
      <div className="user-details">
        <div className="form-box">
          <label htmlFor="sector">Which sector of the economy do you wish to report?</label><br />
        ...
        <div className="form-group agency">
          <label htmlFor="agency">Kindly select the agency you wish to report to</label><br />
        ...
        <div className="form-box">
          <label htmlFor="report-org">Which company, organization or individual is this about?</label>
          <input className="form-input" type="text" id="reportOrg" name="reportorg" />
        </div>

        <div className="form-box">
          <label htmlFor="affiliation">Are you affiliated to the above selected?</label>
        ...
        <div className="form-box">
          ...
          <textarea id="reportInfo" name="reportinfo" required defaultValue={""} />
        </div>
        ...
        <div className="form-box">
          ...
          <label htmlFor="checkbox">I affirm that the information provided is valid</label>
        </div>
        ...
        <div id="myModal" className="modal">
          ...
          <div className="modal-content ">
            ...
            <div className="your_Report"> Your Report Has been Submitted </div>
